...
const TermsCondition = () => {
    ...
    Welcome to Fast Learner </h1>

 <p> These terms and conditions outline the rules and regulations for the use of Company Name's Website, located at fastlearner.com.
